defmodule MdDoctest do
  ...
  alias MdDoctest.Parser

  defdelegate to_doctest(o), to: Parser
  ...
  defmodule Parser do
    ...
    defmacro __before_compile__(env) do
      ...
      moduledoc = binary |> __MODULE__.to_doctest()

      quote do
        Module.put_attribute(unquote(env.module), :moduledoc, {unquote(line), unquote(moduledoc)})
